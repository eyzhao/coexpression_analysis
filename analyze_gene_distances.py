...
interactionsFilename = 'gene_distances.txt'
outputFilename = "output_gene_distance_analysis.txt"
...
for line in interactionsFile:
    ...
    if geneA in fileLineDict and geneB in fileLineDict:
        ...
        output.write("{0}\t{1}\t{2}\t{3}\t{4}\n".format(geneA, geneB, distance, spearmanCoefficient[0], spearmanCoefficient[1]))
